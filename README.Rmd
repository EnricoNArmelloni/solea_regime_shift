...
Sguotti C., Armelloni, E. N., Lizzi S., Scarcella, G.. Mechanisms behind
sudden stock rebuilding: how spatial protection, reduced fishing
pressure, and environmental conditions coincided with a positive tipping
point in the Adriatic Common sole
...
| Q2/M3 | model_3d_input.csv | analysis_3d_model_pa; analysis_3d_model_pos | Spatial analysis: gamm |
...
-   analysis_3d_figures: code to generate all the images showing results
    of spatial analysis

-   extra_figures: generates some figures in the supplementary materials

-   HighstatLibV11: code from [@zuur2019] containing functions to
